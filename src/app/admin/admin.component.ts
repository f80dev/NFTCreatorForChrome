...
import {create_transaction, execute_transaction, init_user_for_web_wallet, signTransaction} from "../mvx";
...
export class AdminComponent {
  ...
  async upload_pem($event: any) {
    ...
    let result=await execute_transaction(await signTransaction(t,this.user),this.user,"fundback")
    wait_message(this)
